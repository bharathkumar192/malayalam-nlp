...
class PreProcessing():
	...
	def data_from_args(self, args):
		if 'wiki' == args.data:
			train_file = [i.strip() for i in open("./data/27k_only_wiki_pruned_sandhi_char_level_training_data",encoding="utf8").readlines()]
		elif 'gold' == args.data:
			train_file = [i.strip() for i in open("./data/13.6k_gold_sandhi_char_level_training_data",encoding="utf8").readlines()]
		elif "full" == args.data:
			train_file = [i.strip() for i in open("./data/40k_gold+wiki_sandhi_char_level_training_data",encoding="utf8").readlines()]
		else:
			train_file = []
	...
	def pre_process(self, args):
		...
		test_file =  open("./data/char_sandhi_6k_gold_with_indexes",encoding="utf8").readlines()
		print("Collected test file", len(test_file), "samples")
		valid_file =  open("./data/validation_data",encoding="utf8").readlines()
...
class Evalauation():
	...
	def loading_model(self, test_data, test_labels, args):
		json_file = open("context.json", 'r')
		loaded_model_json = json_file.read()
		json_file.close()
		loaded_model = model_from_json(loaded_model_json)
		#load weights into new model
		loaded_model.load_weights("context.h5", "r")
...
if __name__ == '__main__':
	...
	outfile = open("context.results", "w")
